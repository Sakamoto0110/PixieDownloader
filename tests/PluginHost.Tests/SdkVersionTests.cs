...
public class SdkVersionTests
{
    ...
    [Theory]
    [InlineData("1.0", true)]      // built against exactly this
    [InlineData("1.0.0", true)]    // the package version spelled out
    [InlineData("1.1", false)]     // built against a newer minor: may call members this host lacks
    ...
    public void A_plugin_runs_on_the_same_major_and_a_minor_no_newer_than_the_host(string? apiVersion, bool expected)
    {
        ...
        Assert.Equal(new Version(1, 0), SdkVersion.Current);
